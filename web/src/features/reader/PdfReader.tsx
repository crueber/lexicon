...
const PdfReader: Component = () => {
  ...
  const [sidebarTab, setSidebarTab] = createSignal<"toc" | "thumbnails">("toc");
                ...
                <For each={thumbnails()}>
                  {(thumb) => (
                    <button
                      ...
                      class={`flex flex-col items-center gap-1 rounded-lg p-1 transition-colors ${
